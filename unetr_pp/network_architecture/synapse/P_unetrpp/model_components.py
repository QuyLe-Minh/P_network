...
from unetr_pp.network_architecture.synapse.P_unetrpp.transformerblock import TransformerBlock
from unetr_pp.network_architecture.dynunet_block import get_conv_layer, UnetResBlock, GathernExcite
...
class UnetrUpBlock(nn.Module):
    ...
    def forward(self, inp, skip, posenc=None, global_embed=False):
        ...
        if isinstance(self.decoder_block[0], SequentialWithArgs):
            ...
            # out = out + self.pos_embed(posenc)  #TODO: check if this is existed in the original code
