...
from p_network.network_architecture.synapse.mdim_transformer.model_components import UnetrPPEncoder, UnetrUpBlock, PosEnc

class TransMDIM(SegmentationNetwork):
    """
