...
from p_network.network_architecture.synapse.synapse_teacher.model_components import UnetrPPEncoder, UnetrUpBlock, PosEnc
...
class UNETR_PP(SegmentationNetwork):
    ...
    def forward(self, x_in, pos, is_posenc=False, require_feature=True):
        if not is_posenc:
        ...
        if require_feature:
            feature_maps = [dec3, dec2, dec1, out]
