...
# from p_network.network_architecture.synapse.bank.transformerblock import TransformerBlock
from p_network.network_architecture.synapse.bank.fused_former import TransformerBlock
...
class HashEncoding(nn.Module):
    def __init__(self, n_input_dim = 3):
        ...
        with open("p_network/network_architecture/synapse/bank/config_hash.json") as f:
        	config = json.load(f)
...
class UnetrUpBlock(nn.Module):
    ...
    def forward(self, inp, skip, posenc, bank=None):
