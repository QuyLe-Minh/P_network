...
import unetr_pp
from p_network.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier
from batchgenerators.utilities.file_and_folder_operations import *
from p_network.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(p_network.__path__[0], "training", "network_training"),
                              base_module='p_network.training.network_training'):
    ...
    plans['plans_per_stage'][Stage]['pool_op_kernel_sizes'] = [[2, 4, 4], [2, 2, 2],
