...
from p_network.run.default_configuration import get_default_configuration
from p_network.paths import default_plans_identifier
...
def main():
    ...
    parser.add_argument("-i", "--input_folder", help="use this if you want to run validation on test folder", type=str, required=True)
    ...
    if find_lr:
        ...
        for file in os.listdir(Tsfolder):
            if file.endswith(".nii.gz"):
                ...
                softmax_output_file = output_file.replace(".nii.gz", ".npz")
                print(file)
